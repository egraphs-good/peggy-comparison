...
public interface MultiMap<K,V> {
    ...
    boolean containsValueSet(Set<? extends V> valueSet);
     ...
     *            <tt>null</tt>.
     */
    Set<V> addValue(K key, V value);

    Set<V> addValues(K key, Collection<? extends V> values);

    Set<V> putValue(K key, V value);

    Set<V> putValues(K key, Collection<? extends V> valueSet);
    ...
    Set<V> removeEntry(K key, V value);
    Set<V> removeValues(K key, Collection<? extends V> values);
    boolean removeValue(V value);
    boolean removeValues(Collection<? extends V> values);
    ...
    void putEach(Map<? extends K, ? extends V> t);
    void putAll(Map<? extends K, ? extends Collection<? extends V>> t);

    void addAll(MultiMap<? extends K, ? extends V> t);
    void addEach(Map<? extends K, ? extends V> t);
    void addAll(Map<? extends K, ? extends Collection<? extends V>> t);
     ...
     */
    Set<? extends MultiMap.Entry<K, V>> entrySet();
    ...
    interface Entry<K,V> {
		 ...
		 *	      <tt>null</tt>.
			 ...
			 *         removed from the backing map
			 */
		Set<V> addValue(V value);
		Set<V> addValues(Collection<? extends V> values);

		Set<V> setValue(V value);
		Set<V> setValues(Collection<? extends V> values);

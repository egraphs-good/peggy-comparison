...
public abstract class AbstractIntCollection extends AbstractCollection<Integer>
   ...
   public boolean contains(Integer o) {return contains(o.intValue());}
   ...
   public boolean add(Integer o) {return add(o.intValue());}
   ...
   public boolean remove(Integer o) {return removeInt(o.intValue());}
   ...
   public boolean intersects(IntCollection that) {
	   if (size() >= that.size()) {
		   for (IntIterator ints = that.iterator(); ints.hasNext(); )
			   if (contains(ints.nextInt()))
				   return true;
	   } else
		   for (IntIterator ints = iterator(); ints.hasNext(); )
			   if (that.contains(ints.nextInt()))
				   return true;
	   return false;
   }

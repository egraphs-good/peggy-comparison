...
public abstract class AbstractIntList extends AbstractIntCollection
   ...
   public Integer remove(int index) {return removeAt(index);}
   ...
   public int indexOf(Object o) {
	   return o instanceof Integer ? indexOf(((Integer)o).intValue()) : -1;
   }
   ...
   public int lastIndexOf(Object o) {
	   return o instanceof Integer ? lastIndexOf(((Integer)o).intValue()) : -1;
   }
   ...
   private class IntListItr extends AbstractIntListIterator {
       /**
       ...
       public void remove() {
           ...
           try {
               AbstractIntList.this.removeAt(lastRet);
               if (lastRet < cursor)
                   cursor--;
               lastRet = -1;
   ...
   public IntList subList(int fromIndex, int toIndex) {
       return (this instanceof RandomAccess ?
               new IntRandomAccessSubList(this, fromIndex, toIndex) :
               new IntSubList(this, fromIndex, toIndex));
   }
    ...
    * @return <tt>true</tt> if the specified object is equal to this list.
    */
   public boolean equals(IntCollection that) {
       if (that == this)
           return true;
       if (that == null)
    	   return false;
       if (that instanceof IntList)
           return equals((IntList)that);
       return false;
   }
   ...
   public boolean equals(List that) {
       ...
       while(e1.hasNext() && e2.hasNext()) {
           ...
           if (o2 == null || !(o2 instanceof Integer)
        		   || e1.nextInt() != ((Integer)o2).intValue())
               return false;
       }
       return !(e1.hasNext() || e2.hasNext());
   }
   ...
   public int getMaximum(int minimum) {
       for (int i = 0; i < size(); i++)
               minimum = Math.max(minimum, get(i));
       return minimum;
   }

   public int getMinimum(int maximum) {
       for (int i = 0; i < size(); i++)
               maximum = Math.min(maximum, get(i));
       return maximum;
   }
}

class IntSubList extends AbstractIntList {
   private AbstractIntList l;
   private int offset;
   private int size;
   private int expectedModCount;

   IntSubList(AbstractIntList list, int fromIndex, int toIndex) {
       if (fromIndex < 0)
...
class IntRandomAccessSubList extends IntSubList implements RandomAccess {
   IntRandomAccessSubList(AbstractIntList list, int fromIndex, int toIndex) {
       super(list, fromIndex, toIndex);
   }

   public IntList subList(int fromIndex, int toIndex) {
       return new IntRandomAccessSubList(this, fromIndex, toIndex);
   }
}
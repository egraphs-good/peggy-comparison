...
/**
 * This class contains the blocks and records for the type block from an
 * LLVM 2.8 bitcode file.
 */
public class TypeBlock2_8 extends Block {
	...
	public static final int TYPE_CODE_METADATA      = 16;   // METADATA
	public static final int LAST_TYPE_CODE			= 16;
	
	public TypeBlock2_8(EnterSubblock _enter) {
		super(_enter);
	}
	...
	public boolean isType2_8() {return true;}
	public TypeBlock2_8 getType2_8Self() {return this;}
}

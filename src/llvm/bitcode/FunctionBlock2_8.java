...
public class FunctionBlock2_8 extends Block {
	...
	public FunctionBlock2_8(EnterSubblock _enter) {
		super(_enter);
	}
	...
	protected void verifyContents(BlockContents bc) {
		if (bc.isBlock()) {
			...
			case FUNC_CODE_INST_CAST: // [val/ty,destty,castopcode]
				...
				break;
			case FUNC_CODE_INST_INBOUNDS_GEP:
			...
			case FUNC_CODE_INST_EXTRACTVAL:
				assertNumericRecord(record, 2, "FUNC_CODE_INST_EXTRACTVAL");
				break;
			case FUNC_CODE_INST_INSERTVAL:
				assertNumericRecord(record, 3, "FUNC_CODE_INST_INSERTVAL");
				break;
			case FUNC_CODE_INST_VSELECT:
				assertNumericRecord(record, 3, "FUNC_CODE_INST_VSELECT");
				break;
			case FUNC_CODE_INST_INDIRECTBR:
				assertNumericRecord(record, 2, "FUNC_CODE_INST_INDIRECTBR");
				break;
			case FUNC_CODE_DEBUG_LOC: // [line,col,scope,ia]
			case FUNC_CODE_DEBUG_LOC2:
				assertNumericRecord(record, 4, "FUNC_CODE_DEBUG_LOC");
				break;
			case FUNC_CODE_DEBUG_LOC_AGAIN:
				assertNumericRecord(record, 0, "FUNC_CODE_DEBUG_LOC_AGAIN");
				break;
			default:
	...
	public boolean isFunction2_8() {return true;}
	public FunctionBlock2_8 getFunction2_8Self() {return this;}
}

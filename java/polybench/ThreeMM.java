...
public class ThreeMM {
    ...
    private static final int NL = 210;
    private static final int NM = 220;
    
    private static void initArray(int ni, int nj, int nk, int nl, int nm,
    ...
    private static void printArray(int ni, int nl, double[][] G) {
    ...
    private static void kernelThreeMM(int ni, int nj, int nk, int nl, int nm,

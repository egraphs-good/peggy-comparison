...
public class Correlation {
    ...
    public static void printArray(int m, double[][] corr) {
    ...
    public static void kernelCorrelation(int m, int n, double float_n, double[][] data, double[][] corr, double[] mean, double[] stddev) {
        double eps = 0.1;

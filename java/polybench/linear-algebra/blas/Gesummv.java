...
public class Gesummv {
    ...
    public static void initArray(int n, double[] alpha, double[] beta, double[][] A, double[][] B, double[] x) {
        alpha[0] = 1.5;
        beta[0] = 1.2;
    ...
    public static void kernelGesummv(int n, double alpha, double beta, double[][] A, double[][] B, double[] tmp, double[] x, double[] y) {
        for (int i = 0; i < n; i++) {
            tmp[i] = 0.0;
            y[i] = 0.0;
            for (int j = 0; j < n; j++) {

...
public class Doitgen {
    ...
    public static final int NP = 60;

    public static void initArray(int nr, int nq, int np, double[][][] A, double[][] C4) {
        for (int i = 0; i < nr; i++) {
            for (int j = 0; j < nq; j++) {
                for (int k = 0; k < np; k++) {
    ...
    public static void printArray(int nr, int nq, int np, double[][][] A) {
    ...
    public static void kernelDoitgen(int nr, int nq, int np, double[][][] A, double[][] C4, double[] sum) {
        for (int r = 0; r < nr; r++) {
            for (int q = 0; q < nq; q++) {
                Arrays.fill(sum, 0.0);

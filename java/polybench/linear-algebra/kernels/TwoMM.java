...
public class TwoMM {
    ...
    public static final int NK = 210;
    public static final int NL = 220;
    
    public static void initArray(int ni, int nj, int nk, int nl, double[] alpha, double[] beta, double[][] A, double[][] B, double[][] C, double[][] D) {
        alpha[0] = 1.5;
        beta[0] = 1.2;
    ...
    public static void printArray(int ni, int nl, double[][] D) {
    ...
    public static void kernelTwoMM(int ni, int nj, int nk, int nl, double alpha, double beta, double[][] tmp, double[][] A, double[][] B, double[][] C, double[][] D) {
        for (int i = 0; i < ni; i++) {
            for (int j = 0; j < nj; j++) {
                tmp[i][j] = 0.0;
                for (int k = 0; k < nk; ++k) {

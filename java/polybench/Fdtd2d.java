...
public class Fdtd2d {
    ...
    private static final int NY = 240;
    
    private static void initArray(int tmax, int nx, int ny, double[][] ex, double[][] ey, double[][] hz, double[] fict) {
    ...
    private static void printArray(int nx, int ny, double[][] ex, double[][] ey, double[][] hz) {
    ...
    private static void kernelFDTD2D(int tmax, int nx, int ny, double[][] ex, double[][] ey, double[][] hz, double[] fict) {
